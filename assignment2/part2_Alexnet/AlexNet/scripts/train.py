...
net_configs = {
    ...
    'cluster2': (attrgetter('distribute'),
                  ...
                  'grpc://localhost:2222',
                  4, 24),
    'localCluster' : (attrgetter('distribute'),
...
def train(net_configname, batch_size, devices=None, target=None,
    ...
    with tf.Graph().as_default():
       ...
       #debug
	print("data name: " , benchmark_name)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--dataset", help='dataset to use', choices=['fake_data', 'flowers'],
                        default='fake_data')
    parser.add_argument("--batch_num", help='total batch number', type=int, default = 96)
